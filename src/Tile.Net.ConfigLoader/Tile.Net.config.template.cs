...
namespace Tile.Net.Config
{
	...
	public class Config : IConfig
    {
        public void Configure(IConfigContext context)
        {
            ...
            context.Layouts.AddLayout(() => new MenuBarLayoutEngine(new VertLayoutEngine(), "Tile.Net.Bar", barHeight));
            context.Layouts.AddLayout(() => new MenuBarLayoutEngine(new HorzLayoutEngine(), "Tile.Net.Bar", barHeight));
